...
class="flex flex-col transition-all h-full overflow-hidden">
    ...
    <header class="px-3 z-10 bg-white sticky top-0 w-full py-2">
        ...
        <div class="border-b justify-between flex items-center pb-2">
            ...
            <button>
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-filter w-7 h-7" viewBox="0 0 16 16">
                ...
                @foreach ($conversations as $key => $conversation)
                    ...
                    class="py-3 hover:bg-gray-50 rounded-2xl dark:hover:bg-gray-700/70 transition-colors duration-150 flex gap-4 relative w-full cursor-pointer px-2 {{ $conversation->id == $selectedConversation?->id ? 'bg-gray-100/70' : '' }}">
                        ...
                        <aside class="grid grid-cols-12 w-full">
                            ...
                            <a href="{{ route('chat', $conversation->id) }}" class="col-span-11 border-b pb-2 border-gry-200 relative overflow-hidden truncate leading-5 w-full flex-nowrap p-1">
